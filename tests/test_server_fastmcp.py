    ...
    def test_create_project_with_folder(self):
        ...
        with mock.patch('omnifocus_mcp.server_fastmcp.get_client') as mock_get_client:
            ...
            mock_client.create_project.assert_called_once_with(
                name="New Project", note=None, folder_path="Work", project_type=None, sequential=False, review_interval_weeks=None, review_interval_value=None, review_interval_unit=None, completed_by_children=None, due_date=None, defer_date=None, planned_date=None
            )
